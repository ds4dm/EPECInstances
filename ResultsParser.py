...
if __name__ == '__main__':
    with open('sumup.csv', 'w', newline='') as file:
        ...
        writer.writerow(["InstanceName", "Tax", "Trade",
                         "One_Production", "One_DomesticPrice", "One_F1_Type", "One_F1_Emission", "One_Production_F1",
                         "One_F2_Type",
                         "One_F2_Emission", "One_Production_F2", "One_F3_Type", "One_F3_Emission ", "One_Production_F3",
                         "One_Import", "One_Export",
                         "One_ExportPrice", "One_Tax",
                         "Two_Production", "Two_DomesticPrice", "Two_F1_Type", "Two_F1_Emission", "Two_Production_F1",
                         "Two_F2_Type",
                         "Two_F2_Emission", "Two_Production_F2", "Two_F3_Type", "Two_F3_Emission", "Two_Production_F3",
                         "Two_Import", "Two_Export",
